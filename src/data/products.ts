...
import monsta from '../assets/monsta.svg';
...
export const products = [
  ...
  },
  {
    ...
    title: 'The Survivor',
    description:
      "Sneaky is the ultimate low-maintenance companion. This plant thrives in low light and can go weeks without water, making it a perfect choice for busy plant parents. Sneaky loves to hide in a corner and purify the air. Just don't overwater, as Sneaky dislikes soggy soil.",
    price: 25.0,
    image: sneaky,
    nickname: 'sneaky',
  },
